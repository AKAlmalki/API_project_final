...
def create_app(test_config=None):
    ...
    in the database and when you refresh the page. [done]
    """
    ...
    at the end of the last page of the questions
    list in the "List" tab. [done]
    """
    ...
    def create_or_search_questions():
        ...
        if searchTerm:
            ...
            try:
                ...
                question.insert()
                # return the created question and the success of the request
                return jsonify({
                    'success': True,
